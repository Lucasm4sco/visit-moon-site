...
export default function SectionDepositions() {
    ...
    return (
        <section id="buy-a-ticket" className="pt-0 p-10 pb-60">
            ...
            <div className="container-limit pt-10 lg:pt-20 min-h-[200px] flex justify-center flex-wrap gap-10">
                {depoiments.map(depoiment => (
                    <figure key={depoiment.author} className="flex items-center gap-10 w-full sm:w-9/12 lg:w-[48%] min-w-[32rem] sm:min-w-[41rem] lg:max-w-[67rem] text-white p-7 border-2 border-gray-theme rounded-[1.1rem]">
                            ...
                            <div className="h-full flex flex-col justify-center gap-6 flex-grow">
                                <div className="flex whitespace-nowrap text-[2rem] sm:text-[2.4rem] xl:text-[3.2rem]">
                                    ...
                                    <span className="text-gray-theme indent-5">
                                        {depoiment.user}
                                    </span>
                                </div>
